...
/**
 * Persistent state component that stores plugin settings including FOP installation directory,
 * user configuration file location, default output format, and bundled FOP usage preference.
 */
@State(
    name = "XslFoSettings",
...
public class XslFoSettings implements PersistentStateComponent<XslFoSettings> {
  ...
  private org.intellij.lang.xslfo.run.OutputFormat myDefaultOutputFormat =
  ...
  public org.intellij.lang.xslfo.run.OutputFormat getDefaultOutputFormat() {
    return myDefaultOutputFormat == null ? org.intellij.lang.xslfo.run.OutputFormat.PDF :
        myDefaultOutputFormat;
  }

  public void setDefaultOutputFormat(org.intellij.lang.xslfo.run.OutputFormat format) {
    this.myDefaultOutputFormat =
        format == null ? org.intellij.lang.xslfo.run.OutputFormat.PDF : format;
  }
